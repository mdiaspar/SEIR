...
WDir <- "c:/users/joel/google drive/github/SEIR-1/"
setwd(WDir)
...
get_plot <- function(data, age_group) {
  ...
  # Add lookup table for age groups
  lookup <- c("< 20 year-olds", "20- to 59-year-olds", "60- to 69-year-olds", "70-79-year-olds", "80+ year-olds")
